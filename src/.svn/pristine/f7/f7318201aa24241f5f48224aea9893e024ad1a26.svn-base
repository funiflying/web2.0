var d = (document.domain || "").match(/chetongxiang(travel)?\.com$/);
...
_.module.event = {}; (function() {
    try {
        for (;;) {
            var a = $topWin.parent;
            if (a && a != $topWin && a.chetongxiang) $topWin = a;
            else break
        }
    } catch(b) {}
})();
...
function $parserRe(a) {
    ...
    function(g, p) {
        try {
            if (p.toLowerCase() !== "jmpinfo" && (d = g.match(c)) && (f = A$(d[1]))) p in chetongxiang.module ? new chetongxiang.module[p](f) : b.push(f)
        } catch(m) {
...
function $d(a) { (A$(a).getAttribute("mod") || "").replace(/\w+/ig,
    function(b) {
        chetongxiang.module[b] ? new chetongxiang.module[b](a) : $isUndefined($$.module.queue[b]) ? $$.module.queue[b] = [a] : $$.module.queue[b].push(a)
    })
}
var $dealElement = $d;
function $t(a, b) {
...
chetongxiang.module.notice = function(a) {
    var b;
    a.module.notice = new
    function() {
        this.enabled = !0;
...
(function() {
    ...
    f = {
        ...
        cityListTagName: "ul",
        cityTagName: "span",
        hotData: {"热门": "@5|奥迪@17|奔驰@",'A': "@5|奥迪@2|阿尔法罗密欧@4|安凯客车@3|阿斯顿·马丁@6|巴博斯@17|奔驰"},
        hotTemplate: {
            ...
            title: '<div class="address_hotcity"><strong>\u70ed\u95e8\u54c1\u724c</strong>{$text}</div>',
    ...
    chetongxiang.module.address = function(k) {
        function v() {
            ...
            if (f.hotData) {
                ...
                var a = f.hotTemplate.container.replaceWith({
                    text: [f.hotTemplate.title.replaceWith({
                        text: $$.module.address.source[o.source + "_keyWord"] || " \uff08\u53ef\u76f4\u63a5\u8f93\u5165\u54c1\u724c\u6216\u54c1\u724c\u62fc\u97f3\uff09"
